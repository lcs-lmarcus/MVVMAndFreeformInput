...
//
//  Created by Marcus Li on 2025-03-26.
//
...
// Test the view model
viewModel.providedBase = "3"
viewModel.providedExponent = "2"
viewModel.power
viewModel.power?.result

// Test the view model with invalid input
viewModel.providedBase = "five"
viewModel.providedExponent = "3"
viewModel.power
viewModel.power?.result
